...
5. Create Microsoft Foundry Resource (Cognitive Services/accounts, kind=AIServices)

6. Create account-level connections:
   - Deploy GPT-4o or other agent-compatible model

7. Create private endpoints with DNS resolution for the Azure Resources: Azure Cosmos DB Account, Azure Storage Storage, Azure AI Search, and Microsoft Foundry
