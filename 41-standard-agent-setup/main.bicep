...
var accountName = 'aifv2-01-std-foundry' // toLower('${aiServices}${uniqueSuffix}')
var projectName = 'aifv2-01-std-foundryproj01-default' // toLower('${firstProjectName}${uniqueSuffix}')


var cosmosDBName = 'aifv2-01-std-foundry-cosmosdb' // toLower('${uniqueSuffix}cosmosdb')
var aiSearchName = 'aifv2-01-std-foundry-aisearch' // toLower('${uniqueSuffix}search')
var azureStorageName = 'aifv201stdfoundrystorage' // toLower('${uniqueSuffix}storage')
